...
# docker run --rm -it -v sitespeed-config:/root/config -v sitespeed-script:/root/script -v sitespeed-result:/sitespeed-result  --entrypoint=bash pageintegrity.azurecr.io/pi-core/pi-qa-sitespeed 


# ATTENTION - we're using '-it' to make it interactive
function test (){
